...
train_gen = ImageDataGenerator().flow_from_dataframe(
    ...
    width_shift_range = 0.3, # width shifting by range 0.1
    height_shift_range = 0.3, # height shifting by range 0.1
    rotation_range=30, #rotation by range 0.1
...
model.add(Dense(4, activation='softmax'))  # Output layer with 6 units for 6 classes and softmax activation for multi-class classification
